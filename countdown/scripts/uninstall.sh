#!/usr/bin/env bash
# ==============================================================================
# Countdown Widget (com.mrudhuhas.countdown) - Uninstaller
...
echo -e "${CYAN}====================================================${NC}"
echo -e "${CYAN}  Uninstalling Countdown Plasmoid (${PLUGIN_ID})     ${NC}"
echo -e "${CYAN}====================================================${NC}"
...
echo -e "\n${GREEN}✔ Countdown plasmoid successfully uninstalled.${NC}"
echo -e "${CYAN}====================================================${NC}"
