#!/usr/bin/env bash
# ==============================================================================
# Calculator Widget (com.mrudhuhas.calculator) - Plasma 6 Installer
...
echo -e "${CYAN}====================================================${NC}"
echo -e "${CYAN}  Installing KDE Plasma 6 Calculator Widget          ${NC}"
...
echo -e "\n${GREEN}✔ Calculator installation / upgrade complete!${NC}"
echo -e "${CYAN}----------------------------------------------------${NC}"
echo -e "Next steps on Fedora 44 / KDE Plasma 6:"
echo -e "  1. Right click your desktop -> ${YELLOW}Add Widgets...${NC}"
echo -e "  2. Search for ${YELLOW}'Calculator'${NC}"
echo -e "  3. Drag and drop it onto your desktop."
echo -e "  4. Click the widget to focus and use either your keyboard or keypad."
echo -e ""
